...
alias ub22='ssh 192.168.64.2'
alias oob='ssh -i ~/.ssh/id_rsa -p 11466 cumulus@worker09.air.nvidia.com'
alias gns3='ssh -l gns3 -i ~/.ssh/id_rsa 172.16.66.129'
alias leaf1='ssh -l cumulus -i ~/.ssh/id_rsa 172.16.66.11'
alias leaf2='ssh -l cumulus -i ~/.ssh/id_rsa 172.16.66.22'
alias leaf4='ssh -l cumulus -i ~/.ssh/id_rsa 172.16.66.44'
alias spine3='ssh -l cumulus -i ~/.ssh/id_rsa 172.16.66.33'
alias centos9='ssh 172.16.66.9'
alias gns3vm1='ssh 192.168.64.10'
alias alp1='ssh root@172.16.66.10'
alias alp2='ssh root@172.16.66.20'
alias ricci-server='ssh 192.168.10.11'
