...
alias Cat9K='ssh -l admin 10.31.120.55'
alias Emb5K-B1='ssh -i ~/.ssh/ansible_id_rsa -l admin 10.31.121.54'
alias Emb5K-B2='ssh -i ~/.ssh/ansible_id_rsa -l admin 10.31.121.55'
