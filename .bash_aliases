alias ..='cd ..'
alias 56leaf57='ssh admin@14.2.86.57'
alias 56leaf58='ssh admin@14.2.86.58'
alias 7k1='ssh admin@14.2.86.59'
alias 7k2='ssh admin@14.2.86.60'
...
alias Emb5K-B1='ssh -l admin 10.31.121.54'
alias Emb5K-B2='ssh -l admin 10.31.121.55'
alias EmbCat68='ssh -l admin 10.31.120.55'
alias EmbN9K-1='ssh -l admin 10.31.121.53'
...
alias bgw31="ssh admin@14.2.86.31"
alias bgw32="ssh admin@14.2.86.32"
alias bgw33="ssh admin@14.2.86.33"
alias bgw34="ssh admin@14.2.86.34"
...
alias chx='chmod +x'
alias clean="egrep -v '(#|^$)' "
alias con='ssh vricci@sjc06-104-Y-02-lt.cisco.com'
alias cont='telnet sjc06-104-Y-02-lt.cisco.com'
...
alias frbgw96='ssh -i ~/.ssh/ansible_id_rsa -l ansible 14.2.86.96'
alias frbgw97='ssh -i ~/.ssh/ansible_id_rsa -l ansible 14.2.86.97'
alias fw='sudo /usr/libexec/ApplicationFirewall/socketfilterfw --listapps'
alias fx2bgw93='ssh -i ~/.ssh/ansible_id_rsa -l ansible 14.2.86.93'
alias fx2bgw94='ssh -i ~/.ssh/ansible_id_rsa -l ansible 14.2.86.94'
alias fxleaf99='ssh -i ~/.ssh/ansible_id_rsa -l ansible 14.2.86.99'
alias gam='git commit -am'
alias gh='git hist'
alias gl2='git log -p -2'
alias gns3='ssh gns3@172.16.139.135'
alias gns3rp="ssh -i ~/.ssh/id_rsa gns3@14.2.86.100"
alias golf='ssh admin@14.2.86.12'
alias grh='git reset HEAD'
alias gs='git status'
alias gsv='git status -v'
alias gx='ssh admin@10.122.165.214'
alias healeaf93='ssh -i ~/.ssh/ansible_id_rsa ansible@14.2.86.93'
alias healeaf94='ssh -i ~/.ssh/ansible_id_rsa ansible@14.2.86.94'
alias host1='ssh -l vincentricci 172.16.17.140'             # CentOS7
alias ipen0='ipconfig getpacket en0'
alias ipen3='ipconfig getpacket en3'
alias ise2='ssh ansible@10.122.171.5'
...
alias log20="ssh admin@14.2.86.116"
...
alias mchost37='ssh admin@14.2.86.37'
alias mchost38='ssh admin@14.2.86.38'
...
alias spine41="ssh admin@14.2.86.40"
alias spine42="ssh admin@14.2.86.42"
alias spine51="ssh admin@14.2.86.51"
alias spine52="ssh admin@14.2.86.52"
alias spine95='ssh -i ~/.ssh/ansible_id_rsa ansible@14.2.86.95'
...
alias t1='tree -a -L 1'
alias t2='ssh admin@14.2.86.42'
alias t2='tree -a -L 2'
alias t2host35='ssh admin@14.2.86.35'
alias t2host36='ssh admin@14.2.86.36'
alias t2host39='ssh admin@14.2.86.39'
alias t2leaf43='ssh admin@14.2.86.43'
alias t2leaf44='ssh admin@14.2.86.44'
alias t7k1='telnet 172.16.113.20 2060'
alias t7k2='telnet 172.16.113.19 2017'
alias tah='ssh admin@14.2.86.49'
alias tahhost36="ssh admin@14.2.86.36"
alias tahhost37='ssh admin@14.2.86.37'
alias tahhost38='ssh admin@14.2.86.38'
alias tahleaf45='ssh admin@14.2.86.45'
alias tahleaf46='ssh admin@14.2.86.46'
alias tahleaf47='ssh admin@14.2.86.47'
alias tahleaf47='ssh admin@14.2.86.47'
alias tahleaf48='ssh admin@14.2.86.48'
alias tahleaf48='ssh admin@14.2.86.48'
alias tahleaf49='ssh admin@14.2.86.49'
...
alias wolbgw100='ssh -i ~/.ssh/ansible_id_rsa -l ansible 14.2.86.100'
alias wolbgw101='ssh -i ~/.ssh/ansible_id_rsa -l ansible 14.2.86.101'
