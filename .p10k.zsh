# Generated by Powerlevel10k configuration wizard on 2020-09-09 at 20:58 PDT.
...
# 2 lines, disconnected, left frame, dark-ornaments, compact, many icons, concise,
...
() {
  ...
  # Solutions from 
  #    keep original venv foldername  https://github.com/romkatv/powerlevel10k/issues/532#issuecomment-612604406
  # or show parent folder https://github.com/romkatv/powerlevel10k/issues/532#issuecomment-592064973
  #typeset -g POWERLEVEL9K_VIRTUALENV_GENERIC_NAMES=()  # keep original venv foldername
  typeset -g POWERLEVEL9K_VIRTUALENV_GENERIC_NAMES=(virtualenv venv .venv env)  # show parent folder as virtualenv
