...
plugins=(ansible docker docker-compose git colored-man-pages colorize pip python brew ssh-agent vagrant virtualenv zsh-nvm zsh-autosuggestions zsh-completions zsh-syntax-highlighting)
